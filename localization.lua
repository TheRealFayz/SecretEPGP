...
Results will print here when done.]],
  ...
  ["PHYS DPS"] = true,
  -- SecretEPGP
  ["{SecretEPGP}Type \"+\" if on main, or \"+<YourMainName>\" (without quotes) if on alt within %dsec."] = true,
  ...
  ["Restart"] = true,  
  ["Restart SecretEPGP if having startup problems."] = true,
  ["Standings"] = true,  
  ["Show Standings Table."] = true,
  ["v%s Loaded."] = true,  
...
L:RegisterTranslations("zhCN", function() return {
  ...
  -- bids
  ["SecretEPGP bids"] = "SecretEPGP 竞拍",
  ["Winning Mainspec Bid: %s (%.03f PR)"] = "副天赋竞标获胜: %s (%.03f PR)",
  ["Winning Offspec Bid: %s (%.03f PR)"] = "副天赋竞标获胜: %s (%.03f PR)",
  -- logs
  ["SecretEPGP logs"] = "SecretEPGP 日志",
  ["Clear Logs."] = "清除日志.",
  ["Time"] = "时间",
  ["Action"] = "行为",
  -- loot
  ["SecretEPGP loot info"] = "SecretEPGP 拾取信息",
  ["Clear Loot."] = "清除拾取.",
  ["Item"] = "物品",
  ["Binds"] = "竞拍",
  ["Looter"] = "拾取人",
  ...
  -- reserves
  ["SecretEPGP reserves"] = "SecretEPGP 替补成员",
  ["Countdown"] = "倒计时",
  ["Rank"] = "Rank",
  ["OnAlt"] = "OnAlt",
     -- standings
  ...
  ["Imported %d members.\n"] = "导入 %d 成员.\n",  
  ["%s\nFailed to import:"] = "%s\n未能导入:",
  ["SecretEPGP standings"] = "SecretEPGP 名单列表",
  ["Group by class"] = "职业分组",
...
完成后打印结果.]],
  ...
  ["PHYS DPS"] = "PHYS DPS",
  -- SecretEPGP
  ["{SecretEPGP}Type \"+\" if on main, or \"+<YourMainName>\" (without quotes) if on alt within %dsec."] = "{SecretEPGP}使用 \"+\" 如果你在大号上, 或者 \"+<YourMainName>\" (没有引号) 如果在小号 %d秒.",
  ...
  ["Restart"] = "重新开始",  
  ["Restart SecretEPGP if having startup problems."] = "重新开始 SecretEPGP，如果有启动问题.",
  ["Standings"] = "排名",  
  ["Show Standings Table."] = "显示排名表.",
  ["v%s Loaded."] = "v%s 加载.",  
  ...
  ["SecretEPGP options"] = "SecretEPGP 设置",
  ["+EPs to Member"] = "+EP给成员",
