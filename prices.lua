local prices = {
  ...
  [18803] = {60,"T1"}; --Finkle's Lava Dredger
  ...
  [18810] = {80,"T1"}; --Wild Growth Spaulders
  ...
  [58205] = {32,"T1"}; --Primal Flamesinger
  [58206] = {80,"T1"}; --Idol of the Forgotten Wilds
  [58207] = {40,"T1"}; --Fist of the Flamewalker
  [58208] = {20,"T1"}; --Shroud of Flowing Magma
  [58209] = {8,"T1"}; --Sizzling Pyreston Aureole
  [58210] = {8,"T1"}; --Grasps of Sundering Power
  [58211] = {150,"T1"}; --Molten Emberstone
  [58212] = {20,"T1"}; --Treads of Scalding Rage
  [58213] = {20,"T1"}; --Smoldaris' Fractured Eye
  [58214] = {40,"T1"}; --Modrag'zan, Heart of the Mountain
  [58215] = {20,"T1"}; --Ash-Forged Greaves
  [58237] = {42,"T1"}; --Emberwoven Binding Garments
  [58238] = {20,"T1"}; --Runed Wardstone
  [58239] = {20,"T1"}; --Overheated Skyrazors
  [58240] = {20,"T1"}; --Libram of Final Judgement
  [58241] = {40,"T1"}; --Totem of Eruption
  [58242] = {8,"T1"}; --Sulfuron Aegis
  [58243] = {60,"T1"}; --Leggings of the Deep Delve
  [58244] = {150,"T1"}; --Sigil of Ancient Accord
  [81260] = {30,"T1"}; --Lavashard Axe
  [81261] = {8,"T1"}; --Boots of Blistering Flames
  [81262] = {8,"T1"}; --Core Forged Helmet
  [81263] = {20,"T1"}; --Lost Dark Iron Chain
  [81264] = {20,"T1"}; --Shoulderpads of True Flight
